...
const NAO_SINT = new Set(['idade_meses', 'idade_anos', 'dias_desde_submissao', 'fichas_72h_mesmo_setor', 'cultura_positiva', 'cultura_mr', 'cultura_organismos', 'cultura_materiais', 'cultura_hemocultura']); // não sintetizáveis com segurança (cross-ficha/relativos a hoje)
